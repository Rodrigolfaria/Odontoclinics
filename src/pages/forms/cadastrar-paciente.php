      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" method="POST" action="processar-paciente.php">
              
              <div class="form-group">
                <label for="nomePaciente">Nome Completo</label>
                <input type="text" name="nome" class="form-control" id="nomePaciente" placeholder="Ex: Maria Oliveira" required>
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="cpf" class="form-control" id="cpfPaciente" placeholder="000.000.000-00">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control" id="emailPaciente" placeholder="paciente@email.com">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="telefonePaciente">Telefone/WhatsApp</label>
                    <input type="text" name="telefone" class="form-control" id="telefonePaciente" placeholder="(11) 99999-9999">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="form-group">
                    ...
                    <input type="text" name="logradouro" class="form-control" id="logradouro" placeholder="Ex: Rua das Flores">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="numero" class="form-control" id="numero" placeholder="123">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                ...
                <div class="col-md-5">
                  <div class="form-group">
                    ...
                    <input type="text" name="complemento" class="form-control" id="complemento" placeholder="Apto, Bloco, etc.">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="estado" class="form-control" id="estado" placeholder="UF">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <textarea name="anamnese" class="form-control" id="anamnesePaciente" rows="6" placeholder="Alergias, medicamentos, cirurgias..."></textarea>
              </div>
